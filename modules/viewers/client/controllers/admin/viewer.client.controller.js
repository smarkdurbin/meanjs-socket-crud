    ...
    function ViewersAdminController($scope, $state, $window, viewer, Authentication, Notification) {
        ...
        function remove() {
            if ($window.confirm('Are you sure you want to delete?')) {
                vm.viewer.$remove(function() {
                    ...
                    Notification.success({ message: '<i class="fas fa-check"></i>&nbsp; Viewer deleted successfully!' });
                });
            }
        }
        ...
        function save(isValid) {
            ...
            function successCallback(res) {
                ...
                Notification.success({ message: '<i class="fas fa-check"></i>&nbsp; Viewer saved successfully!' });
            }
